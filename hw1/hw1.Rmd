...
4. Statistical geneticists often have to reformat a data set to feed into various analysis programs. For example, to use the Mendel software <http://www.genetics.ucla.edu/software/mendel>, we have to reformat the data set to be read by Mendel.
    ...
    ```
     - *I reformatted the data set to be readable by Mendel software. I then piped the output to a new text file "mendelSNP" and moved it to my "hw1" folder. *
    ```{bash}
    ...
    mv mendelSNP /home/l4luo/biostat-m280-2018-winter/hw1
    head -10 /home/l4luo/biostat-m280-2018-winter/hw1/mendelSNP
    ```
